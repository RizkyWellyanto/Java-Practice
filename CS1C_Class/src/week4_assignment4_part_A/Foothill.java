...
public class Foothill
{
   public static void main(String[] args) throws Exception
   {
      ...
      System.out.println("\nTesting Find Min and Find Max "
            + "on a partially soft deleted tree");
      ...
      System.out.println("\nTesting Boolean Empty");
      
      System.out.println("before soft deletion, empty? :"+searchTree3.empty());
      
      searchTree3.remove(100);
      searchTree3.remove(200);
      searchTree3.remove(600);
      
      System.out.println("after soft deletion, empty? :"+searchTree3.empty());
      
      searchTree3.collectGarbage();
      System.out.println("after collect garbage, empty? :"+searchTree3.empty());
...
searchTree2:
10 20 30 50 60 70 200 300 500 600 700 1000 
...
Testing Find Min and Find Max on a partially soft deleted tree
Min: 100
Max: 600

Testing Boolean Empty
before soft deletion, empty? :false
after soft deletion, empty? :true
after collect garbage, empty? :true

Testing a tree with Ebook Entries:
Book Tree mSize: 4814
Book Tree mSizeHard: 4814

Removing some books from the tree
Book Tree mSize: 3199
Book Tree mSizeHard: 4814

Collecting Garbage
Book Tree mSize: 3199
Book Tree mSizeHard: 3199
