package week1_assignment1_part_C;
...
public class Foothill
{
   ...
   public static void main(String[] args) throws Exception
   {
      ...
      int k, j, numSets, max, kBest, arraySize, masterSum, tuneTime;
      ...
      choices.add(new Sublist<iTunesEntry>(dataSet));
      ...
      for (k = 0; k < dataSet.size() && !foundPerfect; k++)
      {
         ...
         {
            tuneTime = dataSet.get(k).getTime();
            ...
            if (tempSum <= TARGET)
               choices.add(choices.get(j).addItem(k, tuneTime));
...
class Sublist<T> implements Cloneable
{
    ...
    * @return
    */
   Sublist<T> addItem(int indexOfItemToAdd, int valOfNewItem)
   {
...
Algorithm Elapsed Time: 0.0092 seconds.
...
Algorithm Elapsed Time: 0.0204 seconds.
...
====SUBLIST====
 SUM = 3000
  ...
  array[14] = Janiva Magness | You Were Never Mine |  4:36
Algorithm Elapsed Time: 0.0595 seconds.
...
Algorithm Elapsed Time: 0.2427 seconds.
...
====SUBLIST====
 ...
 |  13:59
Algorithm Elapsed Time: 21.1006 seconds.
