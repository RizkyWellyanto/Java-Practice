package week2_FHArrayList_iterator_example;
...
public class Foothill
{
   public static void main (String[] args) throws CloneNotSupportedException
   {
      ...
      FHarrayList<String> 
         myStrings = new FHarrayList<String>(),
         myStrings2 = new FHarrayList<String>(),
         myStrings3;
      FHarrayList<Integer> 
         myInts = new FHarrayList<Integer>(INT_ARRAY_SIZE),
         myInts2;
      FHarrayList<Integer> myIntsColl = new FHarrayList<Integer>();
      ...
      // testing clone
      myStrings3 = (FHarrayList<String>)myStrings.clone();
      ...
      for (k = 0; k < 10; k++)
         myIntsColl.add(k);
      myInts2 = new FHarrayList<Integer>();
